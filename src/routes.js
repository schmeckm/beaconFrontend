...
import GetBeaconPositions from './screens/GetBeaconPostions/GetBeaconPositions';
...
const CreateGateway = React.lazy(() => import('./screens/Gateway/create'));
const EditGateway = React.lazy(() => import('./screens/Gateway/edit'));
const GatewayList = React.lazy(() => import('./screens/Gateway/index'));
...
const routes = [
  ...
  { path: '/beacon-positions-lookup', exact: true, name: 'Beacon Positions Lookup', component: GetBeaconPositions},
];
